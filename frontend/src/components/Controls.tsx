...
import { Balanca, Bubble, Check, ChevronDown, Clipboard, Code, Gauge, Image, PanelLeft, Search, Shield, Sliders, Split, X } from "./icons";
...
export const SECOES: { id: Section; label: string; title: string; icon: React.ReactNode }[] = [
  ...
  { id: "imagem", label: "Imagem", title: "Imagens (Stable Diffusion ou nuvem)", icon: <Image className="size-[18px]" /> },
