...
function Ajustes(props: {
  ...
  async function salvarPadrao() {
    try {
      await api.put("/imagens/ajustes", { ...o, model: props.models[0] ?? o.model });
      setSalvo(true);
  ...
  return (
    <aside className="flex w-[300px] shrink-0 flex-col overflow-hidden border-l border-line bg-side text-xs">
      <div className="flex items-center gap-2 px-4 pt-4 pb-1.5">
        ...
        <button onClick={props.onMotor} className="text-[11.5px] text-faint hover:text-fg">Motor e modelos</button>
