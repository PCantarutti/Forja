...
import type { Approval, Attachment, BrowserState, Conversation, Message, RunnerStatus, Settings, Skill, Stats, Task, ToolCall, ToolsSent } from "./types";
...
export default function App() {
  ...
  /** Resposta a um ask_user: volta para o agente como resultado da ferramenta. */
