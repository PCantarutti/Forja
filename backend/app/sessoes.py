...
# Comparação pelo caminho no container: conversa guarda o do sistema do usuário (C:/...), a execução
# enxerga o traduzido (/host/c/...). resolve() leva o primeiro ao segundo.
def _mesma_pasta(c: db.Conversation, pasta: str) -> bool:
    try:
        return str(workspace.resolve(c.workspace)) == pasta
    except workspace.WorkspaceError:
        return False  # pasta que sumiu
